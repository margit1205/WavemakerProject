...
/**
 * Specifies methods used to obtain and modify Cateogry related information
 * which is stored in the database.
 */
@Repository("shopingapp.CateogryDao")
public class CateogryDao extends WMGenericDaoImpl<Cateogry, Integer> {

...
/**
 * Specifies methods used to obtain and modify UserAddress related information
 * which is stored in the database.
 */
@Repository("shopingapp.UserAddressDao")
public class UserAddressDao extends WMGenericDaoImpl<UserAddress, Integer> {

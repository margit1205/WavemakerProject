...
/**
 * Specifies methods used to obtain and modify Orderlist related information
 * which is stored in the database.
 */
@Repository("shopingapp.OrderlistDao")
public class OrderlistDao extends WMGenericDaoImpl<Orderlist, Integer> {

...
/**
 * Specifies methods used to obtain and modify Contact related information
 * which is stored in the database.
 */
@Repository("shopingapp.ContactDao")
public class ContactDao extends WMGenericDaoImpl<Contact, Integer> {
